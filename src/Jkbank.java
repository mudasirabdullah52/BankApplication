...
public class Jkbank implements bank{
    ...
    public HashMap<Integer,Pair> hs = new HashMap<>();
    ...
    public void credit(int balence, int accNumber1, int accNumber2) {
       if(hs.containsKey(accNumber1)  ){
           ...
           System.out.println("your accout: " + accNumber1 + " has been crdits by amount" + balence+" and your available balence is  "+ bal1);
    ...
    public void debit(int accNumber, int balence) {
        if(hs.containsKey(accNumber)){
            System.out.println("this is debited account");
        }
        else {
            System.out.println("this is wrong account no");
        }
    }
